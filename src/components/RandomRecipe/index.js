 ...
 const RandomRecipe = () => {
  ...
  let dietParams = dietParamsOld.substring(1)
      ...
      const fetchRandomRecipe = async () => {
        try {
          const url = `https://api.spoonacular.com/recipes/random/?apiKey=${apiKey}&diet=${dietParams}&intolerances=${intolerancesParams}&excludeIngredients${intolerancesParams}&includeNutrition=true&instructionsRequired=true`
